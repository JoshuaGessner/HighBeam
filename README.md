...
**Pre-alpha** — Project structure and documentation established. Core implementation in progress. See [VERSION_PLAN.md](docs/versioning/VERSION_PLAN.md) for the roadmap.
